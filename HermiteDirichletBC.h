...
#ifndef __HERMITE_DIRICHLET_BC_H
#define __HERMITE_DIRICHLET_BC_H
...
namespace dolfin
{
  ...
  ///
  /// A HermiteDirichletBC is specified by the function g, the function space
  ...
  class HermiteDirichletBC : public Hierarchical<HermiteDirichletBC>, public Variable
  {

  public:

    /// map type used by HermiteDirichletBC
    ...
    HermiteDirichletBC(std::shared_ptr<const FunctionSpace> V,
    ...
    ///
    /// @param[in] bc (HermiteDirichletBC&)
    ///         The object to be copied.
    HermiteDirichletBC(const HermiteDirichletBC& bc);
    ...
    ///
    /// @param[in] bc (HermiteDirichletBC)
    ///         Another HermiteDirichletBC object.
    const HermiteDirichletBC& operator= (const HermiteDirichletBC& bc);
